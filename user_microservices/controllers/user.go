...
func (u *User) UserVerificationRegister(c *gin.Context) {

	params := models.VerificationUpdate{}
	...
	if err != nil {
		...
		data, err := u.daos.UserVerificationRegister(params)
...
func (u *User) UserVerificationRepassword(c *gin.Context) {
	...
	if err != nil {
		...
		data, err := u.daos.UserVerificationRepassword(params)
...
func (u *User) ProfilCreate(c *gin.Context) {

	params := models.CreateProfil{}
	...
	if err != nil {
		...
		data, err := u.daos.ProfilCreate(params)
...
func (u *User) ProfilUpdate(c *gin.Context) {

	params := models.UpdateProfil{}
	...
	if err != nil {
		...
		data, err := u.daos.ProfilUpdate(params)
...
func (u *User) GetDataProfil(c *gin.Context) {
	...
	if err != nil {
		...
		data, err := u.daos.ProfilGet(params)
